...
# Ensure no storage directory exists before deploy
assert_file_missing "$project_path/storage" || exit 1

# Deploy should create storage directory structure
lit deploy > /dev/null

# Storage directory should be created with Laravel structure
